...
def main():
    ...
    application.add_handler(CommandHandler("gasto", gasto.gasto))
    application.add_handler(CommandHandler("renda", renda.renda))
    application.add_handler(CommandHandler("saldo", saldo.saldo))
    application.add_handler(CommandHandler("extrato", extrato.extrato))
